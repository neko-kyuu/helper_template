<template>
  <div class="wardrobe-container">
          <div class="outfit-list">
            ...
            <div v-for="(outfit, outfitId) in mvu.Wardrobe.ownedOutfits" :key="outfitId" class="outfit-item"
          ...
          <div class="outfit-details">
            <template v-if="selectedOutfit">
              <div class="outfit-header">
                ...
                <button @click="equipOutfit(selectedOutfitId)"
                  :disabled="selectedOutfitId === mvu.Wardrobe.currentOutfit">
                  装备
                </button>
              </div>
