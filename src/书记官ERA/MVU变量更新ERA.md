...
rules:
  level: |
    ...
    - 56-60: 近神者 / 神话领域
  attributes: |
    属性: NPC（包括怪物）的属性应基于其自身设定，禁止参考玩家属性进行动态调整。
    - 0-8: 凡人领域
    - 8-12: 一方巧匠
    - 13-15: 天赋异禀
    - 16-19: 精英之巅
...
PlayerData: # Object: 玩家静态数据根对象
  ...
  progress:   # Object: 进度信息
    ...
    nextQuest:       {{ERA:PlayerData.progress.nextQuest}} # Object: QuestData, 下一个可接受的任务
  ...
  settings:   # Object: 元数据
    ...
    bestiary:        {{ERA:PlayerData.settings.bestiary}} # Object: BestiaryEntry, 异怪图鉴
    anecdotes:       {{ERA:PlayerData.settings.anecdotes}} # Object: AnecdoteEntry, 旅途趣闻，可以记录特产、风俗等各类有趣轶事
PlayerDynamicData: # Object: 玩家动态数据
  inventory: {{ERA:PlayerDynamicData.inventory}} # Object: InventoryItem, 玩家的物品
